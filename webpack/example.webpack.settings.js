...
module.exports = {
  ...
  paths: {
    //Configuration of the base paths of the config.
    src: {
      base: "../src/",
      css: "../src/scss/",
      js: "../src/js/",
  ...
  criticalCssConfig: {
    //ToDo: Critical CSS configuration.
    base: "./dist/",
  ...
  devServerConfig: {
    //Configuration for the webpack dev server. Can be set in the .ENV file (not in repo) or the default.
